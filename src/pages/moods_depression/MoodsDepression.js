...
export default function MoodsDepression() {
  ...
  const moodsDepressionUI = (<>
    <nav className='m-2'>
      <ol className="breadcrumb">
        <li className="breadcrumb-item"><Link to="/moods">Moods</Link></li>
        <li className="breadcrumb-item active">Depression</li>
      </ol>
    </nav>
    <p className="fs-3">Depression</p>
