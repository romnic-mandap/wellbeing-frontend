...
export default function MoodsAnxiety() {
  ...
  const moodsAnxietyUI = (<>
    <nav className='m-2'>
      <ol className="breadcrumb">
        <li className="breadcrumb-item"><Link to="/moods">Moods</Link></li>
        <li className="breadcrumb-item active">Anxiety</li>
      </ol>
    </nav>
    <p className="fs-3">Anxiety</p>
