import "./MoodsDepressionInventory.css"
...
export default function MoodsDepressionInventory() {
  ...
  const moodsDepressionInventoryUI = (<>
    ...
    <div>
      <hr />
      <p>4. Less interest or pleasure in usual activities</p>
      <div className="d-flex justify-content-end">
        <div className="btn-group">
    ...
    <div>
      <hr />
      <p>5. Withdrawing from or avoiding people</p>
      <div className="d-flex justify-content-end">
        <div className="btn-group">
    ...
    <div>
      <hr />
      <p>6. Finding it harder than usual to do things</p>
      <div className="d-flex justify-content-end">
        <div className="btn-group">
    ...
    <div>
      <hr />
      <p>9. Difficulty making decisions</p>
      <div className="d-flex justify-content-end">
        <div className="btn-group">
    ...
    <div>
      <hr />
      <p>11. Recurrent thoughts of death</p>
      <div className="d-flex justify-content-end">
        <div className="btn-group">
    ...
    <div>
      <hr />
      <p>12. Spending time thinking about a suicide plan</p>
      <div className="d-flex justify-content-end">
        <div className="btn-group">
    ...
    <div>
      <hr />
      <p>14. Seeing the future as hopeless</p>
      <div className="d-flex justify-content-end">
        <div className="btn-group">
    ...
    <div>
      <hr />
      <p>16. Tiredness or loss of energy</p>
      <div className="d-flex justify-content-end">
        <div className="btn-group">
    ...
    <div>
      <hr />
      <p>17. Significant weight loss or decrease in appetite (do not include weight loss from a diet plan) or weight gain</p>
      <div className="d-flex justify-content-end">
        <div className="btn-group">
    ...
    <div>
      <hr />
      <p>18. Change in sleep pattern - difficulty sleeping or sleeping more or less than usual</p>
      <div className="d-flex justify-content-end">
        <div className="btn-group">
    ...
    <div>
      <hr />
      <p>19. Decreased sexual desire</p>
      <div className="d-flex justify-content-end">
        <div className="btn-group">
    ...
    <Modal show={show} onHide={handleClose} centered>
      <Modal.Header closeButton>
        <Modal.Title>Depression Inventory</Modal.Title>
      </Modal.Header>
      <Modal.Body>You scored {score}/57. {parseFloat(score/57*100).toFixed(1)+"%"}</Modal.Body>
      <Modal.Footer>
