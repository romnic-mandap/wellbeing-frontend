...
*/
export default function FoodTableStats({foodTableStatsObj, setDeleteAllFunction}){
    ...
    return (<>
        ...
        <tbody>
          <tr>
            ...
            <td className='col-3' colSpan={1}><button className="btn btn-primary w-100 p-0" type="button" onClick={()=>handleDeleteAllClick()}>Delete All</button></td>
          </tr>
          <tr>
