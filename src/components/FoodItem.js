...
*/
export default function FoodItem({ foodItemObj, setAddFunction }) {
    ...
    <Table striped bordered hover size="sm">
      <tbody>
        <tr>
          ...
          <td className='col-3' colSpan={1}><button className="btn btn-primary w-100 p-0" type="button" onClick={() => handleAddClick(foodItemObj.id)}>Add</button></td>
        </tr>
        <tr>
